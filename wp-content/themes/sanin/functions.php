...
/*-------------------------------------------------------------------------------------------*/
/* Sanin_Products Post Type */
/*-------------------------------------------------------------------------------------------*/
	class Sanin_Products {

		function Sanin_Products() {
		...
		function create_post_type() {
			$labels = array(
			    ...
			    'edit_item' => 'ערוך מוצר חדש',
			    'new_item' => 'מוצר חדש',
			    'view_item' => 'לראות את המוצרים',
			    'search_items' => 'למצוא מוצר',
			    'not_found' =>  'לא נמצא המוצר',
			    'not_found_in_trash' => 'לא נמצא בסל',
			...
			register_post_type('Sanin_Products',$args);
		}
	}

	$Sanin_Products = new Sanin_Products();
